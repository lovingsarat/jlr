...
ALL_BRAND_ACCOUNTS = JLR_ACCOUNTS
...
def detect_brand(text: str) -> str:
    """Always return 'jlr' for JLR application."""
    return "jlr"
...
def analyze_review_with_gemini(text: str, brand_hint: str = "jlr") -> dict:
    ...
    prompt = f"""
    Analyze the following social media post or review about an automotive brand (JLR).
    ...
    1. "sentiment": Must be "Positive", "Neutral", or "Negative".
       ...
       - "Neutral" for factual questions, balanced observations, or general news.

    2. "brand": Must be "jlr"

    3. "brand_group": The sub-brand:
       - Must be one of: "Jaguar", "Range Rover", "Defender", or "Discovery"
