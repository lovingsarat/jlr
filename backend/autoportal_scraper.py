...
# YouTube video reviews (JLR only)
JLR_YOUTUBE_URLS = [
...
def analyze_with_gemini(text: str, brand_hint: str, vehicle_model: str = "General") -> dict:
    ...
    prompt = f"""
Analyze this automotive review from a portal (AutoExpress/Trustpilot).
Known vehicle: {vehicle_model}. Brand context: {brand_context}

Return JSON with:
- "sentiment": "Positive", "Neutral", or "Negative"
- "brand": "jlr"
- "brand_group": "Jaguar", "Range Rover", "Defender", or "Discovery"
...
- "priority_score": 1–5
- "action_insight": one actionable sentence for the JLR team
...
def main():
    ...
    # JLR — YouTube Comments
    print("\n=== Scraping YouTube Comments (JLR Only) ===")
    for url, vehicle_model, brand_hint in JLR_YOUTUBE_URLS:
